...
PKGS=(
  ...
  # Libraries
  openssl-devel openssl激 readline-devel zlib-devel libyaml-devel libffi-devel gdbm-devel ncurses-devel libuuid-devel libssh2-devel libgit2-devel ruby-devel @virtualization virt-manager virt-viewer gnome-keyring-pam xdg-desktop-portal xdg-desktop-portal-kde xdg-desktop-portal-gnome
  # Runtimes
  ...
  # Editors/Shell
  neovim fzf gh tree kitty tmux zsh man-pages gnome-terminal gnome-tweaks drawing
  # Network
